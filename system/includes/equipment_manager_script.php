...
<script type="module">
    ...
    import {Ajax, ToData, addHtml, ListenToForm} from "./scripts/Tool.js";
    ...
    function getTableContent(start, status) {
        Ajax({
            url: `_getAllBorrowed.php`,
            type: "POST",
            data: ToData({ start: start, status: status }),
            success: (popup) => {
    ...
    function tableManager() {
        ...
        printBtn.addEventListener("click", function () {
            ...
            doc.autoTable({ html: '#print-table', didDrawPage: function(data) {
                    doc.setFontSize(20);
                    doc.setTextColor(40);
