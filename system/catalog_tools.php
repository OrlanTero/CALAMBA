...
<body>
<?php 
include "./includes/user_navigationbar.php";
    ...
    <div class="body">
        <div class="search-engine-container" style="padding-bottom: 20px">
            <div class="search-engine">
                <input type="search" class="search-engine" name="search" placeholder="Search Tools">
            </div>
            <?php if ($isAdmin) : ?>
                <select class="select-course" id="courseSelect" required style="margin-left: 20px">
