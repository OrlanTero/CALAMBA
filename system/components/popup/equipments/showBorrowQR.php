        ...
        <div class="main-popup-content">
            ...
            <form class="form-control">
                <div class="popup-bot">
                    ...
                    <?php if ($record['request_status'] == "accepted" && $record['borrow_status'] == "returned"): ?>
                    <div class="form-group">
                        <label for="serials">Item Condition</label>
                        <input type="text" id="serials"  value="<?php echo ucwords(str_replace('_', ' ', $item['item_condition'])) ?>"  readonly />
                        </div>
                        <?php endif  ?>
                        ...
                        <?php if(!$isUser): ?>
                            <div class="form-group mb-3">
                                    <?php if ($record['request_status'] != 'accepted'): ?>
                                        ...
                                        <select id="status" required class="form-control" name="request_status">
                                    ...
                                    <?php else: ?>
                                        <?php if ($record['borrow_status'] != "returned"): ?>
                                            <label for="serials">Borrow Status: </label>

                                            <select id="status" required class="form-control" name="borrow_status">
